...
const Table = ({ starship, fetchAdditionalData, collapsed }) => {
  return (
    <TableView>
      <Section>
        ...
        <TouchableOpacity
          onPress={() => fetchAdditionalData(getFilmsForDetailsStarship, starship?.films)}
          delayPressIn={150}>
          <Cell cellStyle="RightDetail" title="Films"/>
